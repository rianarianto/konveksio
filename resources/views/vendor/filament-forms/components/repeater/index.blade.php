@php
    ...
    $autoCollapseNew = (bool) ($getExtraAttributes()['data-auto-collapse-new'] ?? false);
@endphp
    ...
    >
                ...
                @foreach ($items as $itemKey => $item)
                    ...
                    <li
                        ...
                        x-data="{
                            ...
                            @if ($autoCollapseNew)
                                init() {
                                    if (this.$el.closest('.fi-fo-repeater')?._acNew) {
        ...
        @if ($isAddable && $addAction->isVisible())
            <div
                ...
                @if ($autoCollapseNew)
                    x-on:click="$root._acNew = true; setTimeout(() => $root._acNew = false, 3000)"
                @endif
            >
                {{ $addAction }}
            </div>
